<button
    {{ $attributes->merge([
        'type' => 'button',
        'class' => 'inline-flex items-center py-2 pl-2 border border-transparent
    ...
    <svg class="ms-2 -me-0.5 h-4 w-4 mr-2 text-palette-500 dark:text-palette-10" xmlns="http://www.w3.org/2000/svg"
