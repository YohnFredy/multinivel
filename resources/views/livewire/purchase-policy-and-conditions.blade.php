    ...
    <x-dialog-modal wire:model="terms">
        <x-slot name="title">
            <h2 class="text-2xl font-semibold text-blue-500">
                Política de Términos y Condiciones de Compra
            </h2>
        </x-slot>

        <x-slot name="content">
            <h5 class="mb-2 text-justify">Al realizar una compra en nuestra tienda en línea, el cliente acepta los siguientes
            ...
            <h5 class="font-semibold mt-2">2. Política de Envío y Entrega</h5>
            <ul class=" text-sm list-disc pl-6 text-justify">
