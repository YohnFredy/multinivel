            ...
            <div class="col-span-3 mt-4 px-10">
                ...
                <div class="flex items-center py-6">
                    ...
                    <input wire:model.live.debounce.2000ms="quantity" type="number"
                        class="text-center w-16 border-none focus:outline-none focus:ring-0 focus:border-none focus:shadow-none px-0"
                        value="{{ $quantity }}">
    ...
    <div>
        ...
        <ul>
            @foreach ($cart as $index => $product)
                <li>
                    {{ $product['id'] }}
                    <button wire:click="removeFromCart({{ $index }})">Eliminar</button>
                </li>
            @endforeach
        </ul>
